...
- RFC 5321/5322 실용 패턴 (dot-atom + quoted-string, domain-literal 지원)
- 연속 점(`..`) 거부, 전체 문자열 앵커(`^`/`$`) 적용
- 참고: [Writing RFC 5321/5322 Compliant Email Regular Expressions](https://zenn.dev/riya_amemiya/articles/e0270cef8eed0f)
- 플래그: `'i'` (대소문자 무시)
